...
jQuery(document).on('ready', function() {
	...
	_tg_upcomingeventcounter.countdown('2020/06/06', function(event) {
	...
	_tg_upcomingeventcountervtwo.countdown('2021/06/05', function(event) {
		var $this = jQuery(this).html(event.strftime(''
	...
	_tg_locationmap.gmap3({
		marker: {
			address: "200 10th Street NE, Atlanta, Georgia, USA",
			options: {
